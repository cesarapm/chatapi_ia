...
const knowledgeBase = {
  ...
  ubicacion: "Nuestra oficina se encuentra en la Av. Principal 123, Ciudad X.",
  paneles: "Nuestra Paneles Cumplen los mejores estandares",
};
...
const keywords = {
  horarios: ["horarios", "cuando", "horario", "tiempo", "abierto", "atención"],
  pagos: ["formas de pago", "pago", "metodos de pago", "tarjetas", "transferencia"],
  ubicacion: ["ubicación", "donde", "dirección", "oficina", "ubicado", "dirección"],
  paneles : ["eps", "paneles","concreto" ]
};
